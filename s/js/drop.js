document.getElementById("drop-btn").addEventListener("click", () => {
  ...
  title.textContent = username + " | Select shifts to drop:";
  ...
  submitButton.addEventListener("click", () => {
    ...
    JSAlert.confirm(selectedShifts, "Selected shifts:").then(function (result) {
      ...
      JSAlert.alert(
        "This does not mean your shifts aren't your responsibility, please wait for someone to text you to cover your shift.",
        "Shifts dropped successfully!"
      ).then(() => {
        newDiv.remove();
      });
    });
